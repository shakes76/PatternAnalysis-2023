...
def train_valid_split(data_path="AD_NC/", new_path="data/", verbose=False):
    """Split the training dataset in to training and validation sets, while
        maintaining the patient-level split.

    Args:
        data_path (str, optional): path to original dataset. Defaults to "AD_NC/".
        new_path (str, optional): path to save new dataset. Defaults to "data/".
...
def plot_losses(train_losses, valid_losses):
    ...
    Args:
        train_losses (list): list of loss values from training set
        valid_losses (list): list of loss values from validation set
    """
...
def plot_test_loss(test_losses):
    """Plot losses from testing data.

    Args:
        test_losses (list): list of loss values from testing set
    """
    fig, ax = plt.subplots()
...
def plot_embeddings(embeddings):
    """Plot embeddings generated by Siamese network.
        Deprecated - Siamese net used to end in feature vector of size 2.

    Args:
        embeddings (list): embeddings generated by Siamese network.
    """
    AD = {"x": [], "y": []}
    NC = {"x": [], "y": []}
...
def save_embeddings(embeddings):
    """Pickles output of Siamese network.
...
def load_embeddings(path):
    """Loads pickled output of Siamese network.
