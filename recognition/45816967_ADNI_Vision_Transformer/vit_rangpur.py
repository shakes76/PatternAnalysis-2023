...
model = MyViT((1, 192, 192), n_patches=16, n_blocks=16, hidden_d=16, n_heads=8, out_d=2).to(device)
N_EPOCHS = 1000
LR = 0.005
train_losses = []
val_losses = []
...
for epoch in range(N_EPOCHS):
    ...
    torch.save(model.state_dict(), f"vit3_model_{epoch + 1}_{train_loss}.pth")
