...
class Generator(nn.Module):
    def __init__(self, z_dim, w_dim, in_channels, img_channels=3):
        super().__init__()
        self.starting_cte = nn.Parameter(torch.ones(1, in_channels, 4,4)) # constant tensor as starting point, influenced by w and noise when training
    ...
    # Weighted average between last layer and next layer
    # Smoothes transition from lower resolution to higher resolution
    # alpha -> weight: 0 -> 1
...
class Discriminator(nn.Module):
    ...
    def fade_in(self, alpha, downscaled, out):
        # fade-in downsampling by avg pooling and output from CNN
