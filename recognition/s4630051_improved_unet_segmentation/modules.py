...
class ContextBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, pdrop=0.3):
        super(ContextBlock, self).__init()
...
class UNetImproved(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3):
        ...
        self.local1 = LocalisationBlock(128, 128)
        
        self.up2 = UpsamplingBlock(128, 64)
        self.local2 = LocalisationBlock(64, 64)
        self.seg1 = nn.Conv2d(64, out_channels, stride=1, kernel_size=1)
        
        self.up3 = UpsamplingBlock(64, 32)
        self.local3 = LocalisationBlock(32, 32)
        self.seg2 = nn.Conv2d(32, out_channels, stride=1, kernel_size=1)
        
        self.up4 = UpsamplingBlock(32, 16)
        self.local4 = LocalisationBlock(16, 16)
        
        self.conv6 = nn.Conv2d(16, 32, kernel_size=kernel_size, padding=1)
        
        self.seg3 = nn.Conv2d(32, out_channels, stride=1, kernel_size=1)
