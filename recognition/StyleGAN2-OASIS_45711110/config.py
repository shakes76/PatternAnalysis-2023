...
log_resolution = 8      # 256*256 image size as such 2^8 = 256
...
z_dim = 512             # Size of the z latent space [initialise to 256 for lower VRAM usage or faster training]
w_dim = 512             # Size of the style vector latent space [initialise to 256 for lower VRAM usage or faster training]
