...
def main_classifier(model, train_loader, val_loader, criterion, optimizer, epochs):
    ...
    # Save the arrays
    train_loss_path = os.path.join(Config.LOG_DIR, 'classifier/train_losses.npy')
    val_loss_path = os.path.join(Config.LOG_DIR, 'classifier/val_losses.npy')
    train_accs_path = os.path.join(Config.LOG_DIR, 'classifier/train_accs.npy')
    val_accs_path = os.path.join(Config.LOG_DIR, 'classifier/val_accs.npy')
