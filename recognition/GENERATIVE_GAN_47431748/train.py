...
test_data = prep_data(path=FILE_PATH + 'test', img_dim=IMG_SHAPE, batch_size=BATCH_SIZE, shift=PIXEL_SHIFT)
...
num_train_pixels = num_train_images * IMG_SHAPE ** 2
...
def show_vqvae_results(images):
    """
    Plots + Saves input, codebook + reconstructions made by VQ-VAE
    :param images: Images to pass into VQ-VAE
    :return: Saves VQVAE images and SSIM results
    """
...
# Generate and plot reconstructions from test set
