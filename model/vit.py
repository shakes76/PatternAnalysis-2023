...
from utils.utilis_ import load_weights_from_state_dict, fuse_conv_bn
...
def vit_large_patch16_224_in21k(num_classes: int = 21843, pretrained: bool = True, has_logits: bool = True):
    """
    ViT-Large model (ViT-L/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    weights ported from official Google JAX impl:
    ...
    model = VisionTransformer(img_size=224,
                              ...
                              num_classes=num_classes)
    if pretrained:
        state_dict = load_state_dict_from_url("https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_vit_large_patch16_224_in21k-606da67d.pth",
                                              progress=True)
        model = load_weights_from_state_dict(model, state_dict)
    return model
